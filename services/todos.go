...
func FetchTodos(page, pageSize int) ([]models.Todo, uint64) {
	...
	return todos, uint64(totalTodosCount)
}

func FetchPendingTodos(page, pageSize int) ([]models.Todo, uint64) {
	return FetchTodosByCompleted(page, pageSize, false)
}
func FetchCompletedTodos(page, pageSize int) ([]models.Todo, uint64) {
	return FetchTodosByCompleted(page, pageSize, true)
}

func FetchTodosByCompleted(page, pageSize int, completed bool) ([]models.Todo, uint64) {
	var todos []models.Todo
...
func DeleteAllTodos() error {
	database := infrastructure.GetDb()
	return database.Model(&models.Todo{}).Delete(&models.Todo{}).Error
}
