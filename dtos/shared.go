...
func CreatePagedResponse(path string, resources []interface{}, resourceName string, page, pageSize int, totalItemsCount uint64) map[string]interface{} {
...
func CreatePageMeta(path string, loadedItemsCount, page, page_size int, totalItemsCount uint64) map[string]interface{} {
